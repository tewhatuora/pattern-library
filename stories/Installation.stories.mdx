...
[![npm version](https://badge.fury.io/js/@te-whatu-ora%2Fanatomic.svg)](https://www.npmjs.com/package/@te-whatu-ora/anatomic)
...
Anatomic uses the Google Font "Fira Sans" (for the Neural theme) and "Poppins" (for the Web Self-Service theme).
...
<Source language="js" dark filename="index.js" code="import '@te-whatu-ora/anatomic/styles';" />
