...
const themeSettingContext = createContext<ThemeSettingsContext | undefined>(undefined);
...
const useThemePreference = () => {
  const [theme, setTheme] = useLocalStorage<ThemeKey>('theme-preference', defaultTheme);

  return [theme !== undefined && documentedThemes.includes(theme) ? theme : defaultTheme, setTheme] as const;
};
