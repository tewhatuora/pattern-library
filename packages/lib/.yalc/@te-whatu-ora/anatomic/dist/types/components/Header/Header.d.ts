...
import { ButtonRootProps } from '../Button/ButtonRoot';
import { StackProps } from '../Stack/Stack';
import type { Color, ContrastVariant } from '../../types';
declare type HeaderContextType = {
    /** Contrast variant for dark/light UI */
    variant: ContrastVariant;
    color: Color;
};
declare const useHeader: () => HeaderContextType;
...
declare const Header: import("react").ForwardRefExoticComponent<{
    /** Contrast variant for dark/light UI */
    variant?: ContrastVariant | undefined;
} & Pick<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLElement>, HTMLElement>, "key" | keyof import("react").HTMLAttributes<HTMLElement>> & import("react").RefAttributes<HTMLDivElement>>;
declare type HeaderMainProps = ComponentPropsWithoutRef<'div'>;
declare const HeaderMain: import("react").ForwardRefExoticComponent<Pick<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "key" | keyof import("react").HTMLAttributes<HTMLDivElement>> & import("react").RefAttributes<HTMLDivElement>>;
declare type HeaderTeWhatuOraLogoProps = ComponentPropsWithoutRef<'a'>;
declare const HeaderTeWhatuOraLogo: import("react").ForwardRefExoticComponent<Pick<import("react").DetailedHTMLProps<import("react").AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, "key" | keyof import("react").AnchorHTMLAttributes<HTMLAnchorElement>> & import("react").RefAttributes<HTMLAnchorElement>>;
declare type HeaderLeftProps = PropsWithChildren<Partial<StackProps>> & {
    hasLeftMargin?: boolean;
};
declare const HeaderLeft: {
    ({ className, hasLeftMargin, ...props }: HeaderLeftProps): JSX.Element;
    displayName: string;
};
declare type HeaderRightProps = PropsWithChildren<Partial<StackProps>> & {
    hasRightMargin?: boolean;
};
declare const HeaderRight: {
    ({ className, hasRightMargin, ...props }: HeaderRightProps): JSX.Element;
    displayName: string;
};
declare type HeaderLogoProps = BoxProps;
declare const HeaderLogo: import("react").ForwardRefExoticComponent<import("../../css/atoms/atoms").Atoms & {
 ...
 * @constructor
 */
declare const HeaderMenuButton: {
    ({ open, onToggle, className, ...props }: HeaderMenuButtonProps): JSX.Element;
    displayName: string;
};
...
declare const Main: import("react").ForwardRefExoticComponent<Pick<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "key" | keyof import("react").HTMLAttributes<HTMLDivElement>> & import("react").RefAttributes<HTMLDivElement>>;
declare const Left: {
    ({ className, hasLeftMargin, ...props }: HeaderLeftProps): JSX.Element;
    displayName: string;
};
...
declare const Logo: import("react").ForwardRefExoticComponent<import("../../css/atoms/atoms").Atoms & {
    content?: string | undefined;
    translate?: "yes" | "no" | undefined;
    hidden?: boolean | undefined;
    wrap?: string | undefined;
...
declare const TeWhatuOraLogo: import("react").ForwardRefExoticComponent<Pick<import("react").DetailedHTMLProps<import("react").AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, "key" | keyof import("react").AnchorHTMLAttributes<HTMLAnchorElement>> & import("react").RefAttributes<HTMLAnchorElement>>;
declare const MenuButton: {
    ({ open, onToggle, className, ...props }: HeaderMenuButtonProps): JSX.Element;
    displayName: string;
};
export { useHeader, Header, HeaderMain, HeaderLeft, HeaderRight, HeaderLogo, HeaderTeWhatuOraLogo, HeaderMenuButton, Root, Main, Left, Right, Logo, TeWhatuOraLogo, MenuButton, };
export type { HeaderProps, HeaderMainProps, HeaderLeftProps, HeaderRightProps, HeaderLogoProps, HeaderTeWhatuOraLogoProps, HeaderMenuButtonProps, };
