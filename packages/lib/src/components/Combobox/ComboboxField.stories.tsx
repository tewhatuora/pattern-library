...
import Docs from './ComboboxField.docs.mdx';
...
export const SingleSelect: Story = {
  args: {
    ...ComboboxStories.SingleSelect.args,
  },
};

export const SingleSelectMultiline: Story = {
  args: {
    ...ComboboxStories.SingleSelectMultiline.args,
  },
};

export const MultiSelect: Story = {
  args: {
    ...ComboboxStories.MultiSelect.args,
  },
};

export const NoOptions: Story = {
  args: {
    ...ComboboxStories.NoOptions.args,
  },
};

export const Error: Story = {
  args: {
    ...ComboboxStories.Error.args,
